...
The https://www.istqb.org[International Software Testing Qualifications Board (ISTQB)] came up with *Seven Testing Principles* that shed light on what testing can achieve and what not. Without discussing every principle, let us consider the main ideas.
...
[NOTE]
====
- https://www.istqb.org/downloads/category/2-foundation-level-documents.html[International Software Testing Qualifications Board: Certified Tester Foundation Level Syllabus, Version 2018 V3.1, Page 16: Seven Testing Principles]
====
...
We are going to discuss the <<measuring-code-coverage#_measuring_code_coverage, practical use of code coverage tools>> later.

[NOTE]
====
- https://angular.io/guide/testing-code-coverage[Angular guide: Code Coverage]
====
...
Between these two extreme perspectives, there are tests that operate on specific parts of the code, but test _cohesive groups_. They prescind from implementation details and try to take the user’s perspective.
...
<p><small>(Table adapted from a https://testing.googleblog.com/2015/04/just-say-no-to-more-end-to-end-tests.html[Google Testing Blog article] by Mike Wacker.)</small></p>
...
- https://kentcdodds.com/blog/write-tests[Kent C. Dodds: Write tests. Not too many. Mostly integration.]
====
