...
Again, there are several ways how to accomplish this. We are going to use Angular’s `fakeAsync` and `tick` functions. We have introduced them when <<testing-complex-forms#_successful_form_submission, testing a form with async validators>>.
