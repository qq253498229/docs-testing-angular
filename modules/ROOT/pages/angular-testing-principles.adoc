...
[NOTE]
====
- https://angular.io/guide/dependency-injection[Angular 指南：依赖注入]
====
...
Angular团队已经为你做出了决策：使用 https://jasmine.github.io/[Jasmine] 作为测试框架，使用 https://karma-runner.github.io/[Karma] 作为测试运行器。实现代码和测试代码使用 https://webpack.js.org[Webpack] 进行打包。应用程序部分通常在Angular的 https://angular.io/api/core/testing/TestBed[TestBed] 中进行测试。
...
[NOTE]
====
- https://angular.io/cli/test[Angular CLI参考文档：ng test]
====
