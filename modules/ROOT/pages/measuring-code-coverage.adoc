...
In the chapter ../testing-principles/#the-right-amount-of-testing[The right amount of testing], we have identified code coverage as a useful, but flawed metric. As a quantitative measure, code coverage cannot assess the quality of your tests.
