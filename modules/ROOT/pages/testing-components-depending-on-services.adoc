...
There are several practical approaches with pros and cons. We have discussed two main ../faking-dependencies/#faking-dependencies[requirements on fake dependencies]:
...
../faking-dependencies/#faking-functions-with-jasmine-spies[Jasmine spies] are suitable for this job. A first approach fills the fake with standalone spies:
...
2. Whichever approach you choose, make sure to meet the ../faking-dependencies/#faking-dependencies[basic requirements]:
+
** 1. Equivalence of fake and original: The fake must have a type derived from the original.
** 2. Effective faking: the original stays untouched.
